...
{\bf Course}: Experimental Methods in Social Sciences---INWS0059-3002.\\
...
\item Install the last version of the \texttt{cregg} {\bf R} package:
...
# When asked ``Which would you like to update?''
...
\begin{enumerate}
  ...
  \item[{\color{red}\Pointinghand}] This exercise may be completed in groups; however, individual assignment submissions are required.
\end{enumerate}

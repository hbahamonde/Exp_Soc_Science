...
\documentclass[letterpaper]{article}\usepackage[]{graphicx}\usepackage[svgnames]{xcolor}
...
\usepackage[backend=biber,style=authoryear,doi=false,url=false,isbn=false]{biblatex}
...
\begin{itemize}
  ...
  \item {\bf Readings}: 
    ...
    \item[$\diamond$] \href{https://doi.org/10.1017/pan.2020.11}{\fullcite{Jenke2021}}.

...
\item {\bf One Programming Take-Home Exercise}:
...
\item {\bf 28.10}: {\color{ForestGreen}{\bf Causal Inference in Social Science}}.
	...
	\item {\bf 04.11}: {\color{ForestGreen}{\bf Survey Experiments: Conjoint and List Designs}}.
       ...
       \item[{\color{red}$\diamond$}] {\color{red}Give programming take-home exercise: Statistical Analysis of Conjoint Data in \texttt{R}}.

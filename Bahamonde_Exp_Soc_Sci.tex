...
\begin{enumerate}
  \item {\bf One reaction paper submitted online}: You will submit one reaction paper. You have to choose the week, i.e., the topic. {\bf The only week you \emph{cannot} choose is Lecture \#3}.\\
  ...
  \item {\bf One in-class written assignment}: On {\bf Lecture \#3} there will be a 30-minute written test where you will write an essay using pencil and paper. I will give you the question(s). All readings assigned until (including) Lecture \#3 may be included.

%\item {\bf One Programming Take-Home Exercise}: You can download the instructions \href{https://github.com/hbahamonde/Exp_Soc_Science/raw/main/Lectures/Labs/Conjoint/Conjoint_Lab.pdf}{here}. The assignment is {\bf due on 25.11, \emph{before} class begins}, and should be submitted in the respective \texttt{Moodle} assignment section of the course. This exercise may be completed in groups; however, individual assignment submissions are required.

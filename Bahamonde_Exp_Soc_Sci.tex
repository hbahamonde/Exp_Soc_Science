...
\item {\bf Talks}:
  ...
  \begin{itemize}
    \item[$\diamond$] {\bf InvestHub ``Brown Bag’’ Talks}: I organize the monthly talks at \href{https://invest.utu.fi/welfare-research-and-ecosystem/investhub/}{InvestHub}, where we discuss ongoing research, including experimental and quasi-experimental studies. Participation in these seminars is highly encouraged.
  \end{itemize}
...
\item {\bf 28.10}: {\color{ForestGreen}{\bf Causal Inference in Social Science}}.
      ...
      \begin{itemize} 
        ...
        \item[{\color{red}$\diamond$}] {\color{red} Students cast their votes \href{https://doodle.com/meeting/participate/id/dLnyLoXa}{{\color{red}{(\texttt{CLICK HERE})}}} and chose time/date for the ``Guided Tour'' to the PCRC Decision-Making Lab}.

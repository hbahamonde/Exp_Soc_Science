...
\item[{\color{red}\Pointinghand}] {\bf Using AI}: The use of artificial intelligence tools (e.g., ChatGPT) is {\bf forbidden} in this course. The \emph{only} exception is for grammar and style correction, which \emph{must} be explicitly reported by the student.
...
\begin{enumerate}
  \item {\bf One reaction paper submitted online}: You will submit one reaction paper. You have to choose the week, i.e., the topic. {\bf The only week you cannot choose is the ``Lab Experiments'' week}. 
  
  \item {\bf One in-class test}: On {\bf 10.11} there will be a 30-minute written test where you will write an essay using pencil and paper. I will give you the question(s). All readings assigned until 10.11 (including) may be included.\\
...
\item {\bf 27.10}: {\color{ForestGreen}{\bf Causal Inference in Social Sciences}}.
	...
	\item {\bf 03.11}: {\color{ForestGreen}{\bf Survey Experiments: Conjoint and List Designs}}.
       ...
       \item[{\color{red}$\diamond$}] {\color{red}Give programming take-home exercise: Statistical Analysis of Conjoint Data in \texttt{R}. Homework is \underline{due on 25.11} \emph{before} class begins}.

      \end{itemize}


  \item {\bf 10.11}:  {\color{ForestGreen}{\bf Lab Experiments}}.
  ...
  \item {\bf 17.11}:  {\color{ForestGreen}{\bf Natural Experiments}}.
 ...
 \item {\bf 25.11}:  {\color{ForestGreen}{\bf Field Experiments}}.
...
\item {\bf 02.12}:  {\color{ForestGreen}{\bf Ethics}}.

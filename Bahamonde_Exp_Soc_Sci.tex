...
}{here}. The assignment is {\bf due on on 26.11 \emph{before} class}.
...
% 6. 03.12 // Ethical considerations
...
\item {\bf 28.10}: {\color{ForestGreen}{\bf Causal Inference in Social Science}}.
      ...
      \begin{itemize} 
        ...
        \item[$\diamond$] From Correlation to Causation: An Overview.

        \begin{enumerate}

          % Statistical Models and Shoe Leather
          \item[$\bullet$] \href{https://www.jstor.org/stable/270939}{\fullcite{Freedman1991}}.
          ...
          % \item[$\bullet$] David A. Freedman. On regression adjustments to experimental data. Advances in Applied Mathematics, 40(2):180–193, 2008

          % \item[$\bullet$] Paul R. Rosenbaum. Covariance adjustment in randomized experiments and observa- tional studies. Statistical Science, 17(3):286–327, 2002.
	...
	\item {\bf 04.11}: {\color{ForestGreen}{\bf Survey Experiments: Conjoint and List Designs}}.
       ...
       \item[{\color{red}$\diamond$}] {\color{red}Give programming take-home exercise: Statistical Analysis of Conjoint Data in \texttt{R}. Homework is \underline{due on 26.11} \emph{before} class}.
  ...
  \item {\bf 11.11}:  {\color{ForestGreen}{\bf Lab Experiments}}.
        ...
        \begin{enumerate}
          \item[$\bullet$] \href{https://doi.org/10.1017/gov.2018.14}{\fullcite{Bol2019}}.
       ...
       \item[$\diamond$] Applications:
          ...
          \item[$\bullet$] Political participation: \href{https://onlinelibrary.wiley.com/doi/pdf/10.1111/j.1540-5907.2008.00332.x}{\fullcite{Duffy2008}}.
          ...
          \item[$\bullet$] Clientelism [{\bf Bonus!} ``\emph{Lab-in-the-Field}'' Experiments]: \href{https://doi.org/10.1177/0010414017695336}{\fullcite{Gottlieb2017}}.
  ...
  \item {\bf 18.11}:  {\color{ForestGreen}{\bf Natural Experiments}}.
      ...
      \begin{itemize} 
       ...
       \item[$\diamond$] Applications:
          ...
          \item[$\bullet$] Origin of banking systems: \href{https://search.ebscohost.com/login.aspx?direct=true&db=nlebk&AN=516924&site=ehost-live&scope=site&ebv=EB&ppid=pp_88}{\fullcite{Haber2011a}}.

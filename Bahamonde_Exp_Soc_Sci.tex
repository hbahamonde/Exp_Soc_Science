...
\begin{itemize} 
        ...
        \item[$\diamond$] \fullcite{Diamond2011}.

        % Natural Experiments of History
        \item[$\diamond$] \fullcite{Dunning2012}.
